...
/**
 * Stores the log in a replicated raft cluster
 * TODO first implement cheap example ratis client here with additional endpoint to increase pointer
 * TODO implement RaftClient here; write means sending APPEND message and wait
 * TODO raft servers must run in advance
 * TODO may import RaftLogStorageClient implementation from custom project
 * that simply consumes a properties file ?
 * TODO start script for whole cluster
 */
@Service
public class ReplicatedLogPersistenceService implements ILogPersistenceService {

    // TODO should instantiate file path with Properties file
    // TODO should have server id in file path for testing purposes
    private static final String LOG_PATH = "file:///C:/temp/raft-test/1";
