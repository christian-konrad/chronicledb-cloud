...
import de.umr.raft.raftlogreplicationdemo.models.eventstore.InsertEventIntoEmbeddedStoreRequest;
 ...
 */
@JsonComponent
public class InsertEventIntoEmbeddedStoreRequestDeserializer extends JsonDeserializer<InsertEventIntoEmbeddedStoreRequest> {

	private final EmbeddedChronicleEngine engine;
	 ...
	 */
	@Autowired
	public InsertEventIntoEmbeddedStoreRequestDeserializer(EmbeddedChronicleEngine engine, HttpServletRequest request) {
	 ...
	 */
	@Override
	public InsertEventIntoEmbeddedStoreRequest deserialize(JsonParser p, DeserializationContext ctxt)
		...
		return new InsertEventIntoEmbeddedStoreRequest(events);
	}
