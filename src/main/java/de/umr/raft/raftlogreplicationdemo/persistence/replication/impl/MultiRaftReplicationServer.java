...
//        System.out.println(raftGroupsString);
    ...
    private RaftServer buildRaftServer() throws IOException {
        ...
        val raftStorageDir = new File(raftConfig.getStoragePath() + "/" + getServerName());
    ...
    private void broadcastRaftGroupInfo(String groupId, UUID groupUUID, String groupName, String stateMachineType, List<String> nodeIds) throws ExecutionException, InterruptedException {
        val replicatedMetaDataMap = ReplicatedMetadataMap.ofRaftGroupScope(metaDataClient);
